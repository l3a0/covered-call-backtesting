...
[^1]: One number worth keeping straight: the headline ~915% figure from the first post is the fixed-settings return over the *full* ten-year sample (2016–2026). The 483% and 563% here are over the narrower walk-forward window (2018–2025), which trims roughly two years off each end. Comparing 483% to 915% would be comparing different time spans; the honest apples-to-apples comparison is 483% against 563%.
