...
[^1]: Two numbers worth keeping straight, both span mismatches. First: the headline ~915% from the first post is the fixed-settings return over the *full* ten-year sample (2016–2026); the 483% and 563% here are over the narrower walk-forward window (2018–2025), which trims roughly two years off each end. Comparing 483% to 915% compares different time spans; the honest apples-to-apples pair is 483% against 563%. Second, and easy to trip on: the ~646% buy-and-hold figure from the first post is *also* the full ten-year sample. Over the walk-forward window, buy-and-hold returned about 467%, not 646%. So within the matched span the overlay does beat buy-and-hold — but look at the honest version of that gap: walk-forward ~483% against same-span buy-and-hold ~467% is an edge of only about 16 points over seven and a half years. The optimized 563% looks like a comfortable 96-point win; the no-hindsight number barely clears the stock. That thin margin isn't a footnote detail — it's the whole question the final post answers.
